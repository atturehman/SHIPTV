...
<span style="color:yellow;" class="loading-text-words">S</span>
<span style="color:blue;" class="loading-text-words">H</span>
<span style="color:red;" class="loading-text-words">-</span>
<span style="color:yellow;" class="loading-text-words">I</span>
<span  style="color:blue;" class="loading-text-words">P</span>
<span style="color:yellow;" class="loading-text-words">T</span>
<span  style="color:red;" class="loading-text-words">V</span>
</div>
</div>
